...
data class DrawableData(
    ...
    companion object Factory {
        ...
        private fun List<Measurement>.splitByType(): Map<KClass<out Measurement>, List<Measurement>> {
            val result =
                mutableMapOf<KClass<out Measurement>, MutableList<Measurement>>()
