...
import ru.health.stream.automapper.processor.builder.MapperBuilderFactory
import ru.health.stream.automapper.processor.model.MapperDefinition
...
internal class AutoMapperProcessor(
    ...
    private fun processMapperFunction(
        ...
        val isReversive = mapperAnnotation.arguments
            .firstOrNull { args -> args.name?.asString() == "isReversive" }
